# Generated by Django 5.1.2 on 2024-11-21 15:08
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="news", to="news.keyword"
                    ),
                ),
                (
                    "reporter",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "keyword",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="news.keyword"
                    ),
                ),
                (
                    "news",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="special_category1",
                to="news.specialcategory",
            ),
        ),
        migrations.AddField(
            model_name="newsspecialattributes",
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="special_category2",
                to="news.specialcategory",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="special_feature1",
                to="news.specialfeature",
            ),
        ),
        migrations.AddField(
            model_name="newsspecialattributes",
